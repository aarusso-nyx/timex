...
export class GanttViewComponent implements OnInit {
  ...
  private redraw(stays: Stay[]): void {
    ...
    const items = this.root
      ...
      // .on('contextmenu', this.showMenu)
      .on('contextmenu', function(this: Element, event: MouseEvent, d: any): void {
        // event.preventDefault();
        that.showMenu(this, event, d);
  ...
  //////////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////////
  private showMenu(el: Element, event: MouseEvent, d: any): void {
    event.preventDefault();
    const menu = d3.select('div.context-menu');
    const [x, y] = event instanceof MouseEvent ? [event.x, event.y] : [0, 0];
